...
class EggApp extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return ChangeNotifierProvider<UserPro>(
...
BeamerDelegate _routerDelegate = BeamerDelegate(
  guards: [BeamGuard(
    ...
    check: (context, location) {
      logger.d("HowMany? 현재상태: ${Provider.of<UserPro>(context, listen: true).userState}");
      ...
      ///리빌딩이 왜 안되는 거냐고
      return Provider.of<UserPro>(context, listen: true).userState;
